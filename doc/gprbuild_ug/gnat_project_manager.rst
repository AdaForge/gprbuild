...
.. only:: html or latex
   ...
   This project structure is shown in :numref:`figure %s<fig-badproject>`.
...
.. only:: html or latex
   ...
   This project structure is shown in :numref:`figure %s<fig-goodproject>`.
...
.. only:: html or latex
   ...
   This project structure is shown in :numref:`figure %s<fig-simpleproject>`.
...
.. only:: html or latex
   ...
   The resulting project structure is shown in :numref:`figure %s<fig-extends_all>`,
...
**Project_Path**:
  ...
  * and finally the predefined directories.
  ...
  .. only:: html or latex
     ...
     :numref:`figure %s<fig-aggproject_error>`.
...
* An external reference (see :ref:`Link title <External_Values>`)
...
is often given by an external reference (see :ref:`Link title <External_Values>`).
